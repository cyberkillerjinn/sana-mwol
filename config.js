...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By 𝗔𝗦𝗪𝗔𝗧𝗛𝗬' : process.env.ALL_CAPTION,
    ...
    SAID: process.env.BGM_DURATION === undefined ? '10.5' : process.env.BGM_DURATION,
    FULLEVA: process.env.FULL_EVA === undefined ? 'false' : process.env.FULL_EVA,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝗔𝗦𝗪𝗔𝗧𝗛𝗬 𝐁𝐎𝐓' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://instagram.com/kl_35_pala_karannn?utm_medium=copy_link' : process.env.SOCIAL_MEDIA,
