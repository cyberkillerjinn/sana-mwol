...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
    if (therikick_var == 'true' && message.jid !== '905511384572-1616356915@g.us') {
        ...
        let regex9 = new RegExp('myre')
        let regex10 = new RegExp('Myre')
        let regex11 = new RegExp('pari')
        let regex12 = new RegExp('Pari')
        let regex13 = new RegExp('Andi')
        let regex14 = new RegExp('andi')
        let regex15 = new RegExp('Nari')
        let regex16 = new RegExp('nari')
        let regex17 = new RegExp('Patti')
        let regex18 = new RegExp('Kundan')
        let regex19 = new RegExp('kundan')
        let regex20 = new RegExp('pooran')
        let regex21 = new RegExp('Pooran')
